...
#driver.get("https://docs.google.com/forms/d/e/1FAIpQLSfWfPcADbvEPrGDePWhY-agioR1TAyFZTW-hwNTucN28-VACg/viewform")
#myDynamicElement = driver.find_element_by_css_selector(".quantumWizTogglePaperradioOffRadio")
#driver.implicitly_wait(3000)

class TestTesteConsideraEsporte():
  ...
  def test_testeConsideraEsporte(self):
    # Test name: Teste_Considera _Esporte
    ...
    self.driver.find_element(By.CSS_SELECTOR,Active,".quantumWizTogglePaperradioOffRadio").click()
